...
public class RegexpExtractSparkTest {
  ...
  @Test
  public void testRegexpExtractReturnsEmptyStringOnNoMatch() {
    try (RowVector input = makeVarcharRowVector("no_match_here")) {
      ...
      try (BufferAllocator alloc = new RootAllocator();
        ...
        Assert.assertFalse(
            "Spark preset: no match should return empty string, not null", fv.isNull(0));
